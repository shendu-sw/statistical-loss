...
void caffe_cpu_strsm(const CBLAS_SIDE Side, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA,
...
template <typename Dtype>
void caffe_cpu_sgesv(const int M, const int N, const float* A, float* B);

template <typename Dtype>
void caffe_cpu_sgesv(const int M, const int N, const double* A, double* B);
